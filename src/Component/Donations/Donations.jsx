    ...
    return (
        <div style={{backgroundColor:card_bg_color}} className="rounded-lg flex w-auto gap-6">
           ...
           <div>
            ...
            <h3 className="text-2xl text-[#0B0B0B] font-semibold mb-1">{title}</h3>
            <p style={{color:text_button_bg_color}} className="text-base font-semibold mb-5 ">${price}</p>
            <Link><button style={{backgroundColor:text_button_bg_color}} className="py-2 px-4 mb-8 rounded text-lg font-semibold text-[#FFF]">View Details</button></Link>
